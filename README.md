...
이 프로그램은 리눅스 시스템 프로그래밍 수업 중 학습한 소켓통신 개념이 통합 활용된 더 실용적이기 위한 실습 주제로 선택하였습니다.

수업 중 다룬 예제들 중 파이프 단방의 채팅 프로그래밍과 소켓 단방 파일 다운로드 프로그램의 양쪽 장점으로, 두 기능을 결합하여 실용성과 학습 효과를 높이고자 것이고, 생각해보면 실무에서의 실제 시나리오에 복합된다.
...
이번 기말 실습을 통해 리눅스 기반 네트워크 통신과 소켓 프로그래밍의 기초부터 응용까지 경험할 수 있었으며, 중반부터 네트워크 대역 더 넓어보면 실시간 서비스 설계의 중요성과 사려깊은 시설정 넘나들면서.
